...
void main(void) {
    ...
    memcpy(hello+14, "I love you.\r\n", 13);
    kprintf("we add something to the string, it says: %s", hello);
    memory_set_page_flags(hello, 0);
    kprintf("now we makes it unwritable! trying to add again\n");
    memory_set_page_flags(hello, PTE_R);
    memcpy(hello+25, "I love you too.\n", 16);
